...
module.exports = class Migration1728012635886 {
    name = 'Migration1728012635886'
    ...
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE \`user_group\` (\`id\` int NOT NULL AUTO_INCREMENT, \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deleted_at\` datetime(6) NULL, \`user_id\` int NULL, \`group_id\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`ALTER TABLE \`post\` DROP COLUMN \`post_id\``);
        await queryRunner.query(`ALTER TABLE \`post\` ADD \`post_vkid\` int NOT NULL`);
    ...
    async down(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE \`post\` DROP COLUMN \`post_vkid\``);
        await queryRunner.query(`ALTER TABLE \`post\` ADD \`post_id\` int NOT NULL`);
